...
<div class="container">
<div class="items"></div>
<div class="items"> <input type="checkbox" value="selectall" onchange='s(this);' name="selectall">Select All &emsp;</div>
<div class="items"><input type="checkbox" value="deselectall" onchange='d(this);' >Deselect All<br></div>
<div class="items"></div>
<div class="items"><input type="checkbox" name="Report[]" value="Diesel">Diesel &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="Lubricants">Lubricants &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="Insurance">Insurance &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="Taxes">Taxes<br></div>
<div class="items"><input type="checkbox" name="Report[]" value="ElectricalRepairs">ElectricalRepairs &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="EngineRepairs">EngineRepairs &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="BodyRepairs">BodyRepairs &emsp;</div>
<div class="items"><input type="checkbox" name="Report[]" value="Others">Others<br><br></div>
</div>
<button type="submit" id="dis" value="Display" name="display"/>Display</button>
<button type="submit" id="dis" value="Export" name="export"/>Export</button>
</div>
</form><br><br>
<script>
  function s(c)
