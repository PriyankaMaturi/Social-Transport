...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($res) == 0) {
        ...
        foreach ($pdfs as $pdf ) {
            ...
            echo "<tr><td>" . $busid . "</td><td>" . $issuedate . "</td><td>" . $expiry . "</td><td>" . $owner . "</td><td>" . $hypto . "</td><td>" . $hypdate . "</td><td>" . $chasno . "</td><td>" . $engno . "</td><td>" . $vehclass . "</td><td>" . $seatcap . "</td><td>" . $pmr . "</td><td><a href='" . $pdf . "'>Download</a></td><td> <a href='?delete=" . $combined_name . "'>Delete</a></td></tr>";
        }
        echo "</table>";
        }else{
